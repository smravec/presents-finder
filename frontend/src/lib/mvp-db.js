...
export const MvpData = [
    ...
    [
        ...
        ["Book-themed Playing Cards", "Playing cards featuring classic book covers", ["Reading", "Gaming (e.g., Board Games, Video Games)"], ["Child", "Teen"], [], "More enjoyable", "both", "both"],
        ["Bookmark with Built-in Dice", "A functional bookmark that also acts as a die for gaming", ["Reading", "Gaming (e.g., Board Games, Video Games)"], ["Teen", "Young Adult"], [], "More practical", "both", "both"],
        ["Mini Book Puzzle", "A small puzzle that forms a book when completed", ["Reading", "Gaming (e.g., Board Games, Video Games)"], ["Child", "Teen"], [], "More enjoyable", "both", "both"],
        ["DIY Miniature Bookshelf for Board Games", "A small DIY project to make a miniature bookshelf for board game pieces", ["Reading", "Gaming (e.g., Board Games, Video Games)"], ["Young Adult", "Adult"], [], "More practical", "both", "both"],
        ["Board Game-themed Bookends", "Bookends that are designed with a board game theme", ["Reading", "Gaming (e.g., Board Games, Video Games)"], ["Adult", "Senior"], ["Birthday", "Christmas", "Anniversary"], "More enjoyable", "both", "both"],
        ["Magnetic Book and Game Holder", "A device that holds a book open and also has areas to hold game pieces", ["Reading", "Gaming (e.g., Board Games, Video Games)"], ["Teen", "Young Adult"], [], "More practical", "both", "both"],
        ["Literature Trivia Game", "A trivia game focused on literature and book knowledge", ["Reading", "Gaming (e.g., Board Games, Video Games)"], ["Adult", "Senior"], [], "More enjoyable", "both", "both"],
        ["DIY Dice Tower with Book Decor", "A DIY dice tower that has book-themed decorations", ["Reading", "Gaming (e.g., Board Games, Video Games)"], ["Teen", "Young Adult"], [], "More practical", "both", "both"],
        ["Story Dice", "Dice that help in creating stories, enhancing both reading and gaming experience", ["Reading", "Gaming (e.g., Board Games, Video Games)"], ["Child", "Teen"], [], "More enjoyable", "both", "both"],
        ["Book Cover for Board Games", "A book cover that can also be used to store or camouflage board games", ["Reading", "Gaming (e.g., Board Games, Video Games)"], ["Adult", "Senior"], [], "More practical", "both", "both"]
    
        ["Manga-themed Bookmarks", "Beautiful bookmarks featuring popular manga characters", ["Reading", "Anime/Manga"], ["Child", "Teen"], [], "More practical", "both", "both"],
        ["Chibi Character Page Holder", "A cute chibi character that holds the pages of your book", ["Reading", "Anime/Manga"], ["Child", "Teen"], [], "More enjoyable", "both", "both"],
        ["Manga Cover Notebook", "A notebook with a cover inspired by popular manga series", ["Reading", "Anime/Manga"], ["Teen", "Young Adult"], [], "More practical", "both", "both"],
        ["Anime Quote Bookmarks", "Bookmarks featuring famous and inspiring quotes from various anime", ["Reading", "Anime/Manga"], ["Teen", "Young Adult"], [], "More enjoyable", "both", "both"],
        ["DIY Paper Craft Manga Characters", "Paper crafting kit to create manga characters", ["Reading", "Anime/Manga"], ["Child", "Teen"], [], "More practical", "both", "both"],
        ["Manga Drawing Guide for Beginners", "A beginner's guide book to drawing manga characters", ["Reading", "Anime/Manga"], ["Teen", "Young Adult"], [], "More enjoyable", "both", "both"],
        ["Mini Manga Puzzles", "Small puzzles featuring scenes or characters from popular manga", ["Reading", "Anime/Manga"], ["Child", "Teen"], [], "More practical", "both", "both"],
        ["Book Sleeves with Anime Designs", "Protective sleeves for books with beautiful anime designs", ["Reading", "Anime/Manga"], ["Young Adult", "Adult"], [], "More enjoyable", "both", "both"],
        ["Anime/Manga Story Cubes", "Dice with images for creating your own anime or manga stories", ["Reading", "Anime/Manga"], ["Child", "Teen"], [], "More practical", "both", "both"],
        ["Manga Scene Bookmarks", "Bookmarks that represent various scenes from popular manga series", ["Reading", "Anime/Manga"], ["Teen", "Adult"], [], "More enjoyable", "both", "both"]
        
        ["Paintable Book Cover", "A customizable book cover that one can paint or draw on", ["Reading", "Artistic Activities (e.g., Drawing, Painting, Crafting)"], ["Child", "Teen"], [], "More practical", "both", "both"],
        ["Coloring Bookmarks", "Bookmarks that can be colored in with various designs", ["Reading", "Artistic Activities (e.g., Drawing, Painting, Crafting)"], ["Child", "Teen"], [], "More enjoyable", "both", "both"],
        ["DIY Bookends Crafting Kit", "A kit to create custom, artistic bookends", ["Reading", "Artistic Activities (e.g., Drawing, Painting, Crafting)"], ["Teen", "Young Adult"], [], "More practical", "both", "both"],
        ["Art-themed Bookmarks", "Bookmarks featuring famous paintings and artworks", ["Reading", "Artistic Activities (e.g., Drawing, Painting, Crafting)"], ["Young Adult", "Adult"], [], "More enjoyable", "both", "both"],
        ["Book Cover Design Kit", "A set that allows customization of book covers with artistic designs", ["Reading", "Artistic Activities (e.g., Drawing, Painting, Crafting)"], ["Teen", "Adult"], [], "More practical", "both", "both"],
        ["Literature Quote Prints", "Printable artworks featuring quotes from classic literature", ["Reading", "Artistic Activities (e.g., Drawing, Painting, Crafting)"], ["Adult", "Senior"], ["Birthday", "Christmas", "Anniversary"], "More enjoyable", "both", "both"],
        ["Craft Paper Books", "Books made of craft paper for doodling or sketching", ["Reading", "Artistic Activities (e.g., Drawing, Painting, Crafting)"], ["Child", "Teen"], [], "More practical", "both", "both"],
        ["Drawing Techniques Book", "A book detailing various drawing techniques and practices", ["Reading", "Artistic Activities (e.g., Drawing, Painting, Crafting)"], ["Teen", "Young Adult"], [], "More enjoyable", "both", "both"],
        ["Art Supply Organizer with Bookshelf", "An organizer that holds art supplies and has a space for books", ["Reading", "Artistic Activities (e.g., Drawing, Painting, Crafting)"], ["Young Adult", "Adult"], [], "More practical", "both", "both"],
        ["Literary Art Stencils", "Stencils of quotes or images from famous literature for artistic projects", ["Reading", "Artistic Activities (e.g., Drawing, Painting, Crafting)"], ["Teen", "Adult"], [], "More enjoyable", "both", "both"]
    
        ["LED Book Light", "A clip-on LED light for night-time reading", ["Reading", "Tech and Gadgets"], ["Child", "Teen"], [], "More practical", "both", "both"],
        ["Bookish USB Flash Drive", "A USB flash drive designed to look like a mini book", ["Reading", "Tech and Gadgets"], ["Teen", "Young Adult"], [], "More enjoyable", "both", "both"],
        ["Book-themed Phone Stand", "A phone stand that looks like a book or features a literary design", ["Reading", "Tech and Gadgets"], ["Teen", "Adult"], [], "More practical", "both", "both"],
        ["Electronic Dictionary Bookmark", "A bookmark that also functions as an electronic dictionary", ["Reading", "Tech and Gadgets"], ["Young Adult", "Adult"], [], "More enjoyable", "both", "both"],
        ["Magnetic Page Markers with Tech Designs", "Magnetic page markers featuring designs inspired by tech themes", ["Reading", "Tech and Gadgets"], ["Child", "Teen"], [], "More practical", "both", "both"],
        ["E-Reader Bean Bag Stand", "A comfortable bean bag stand to hold e-readers or tablets", ["Reading", "Tech and Gadgets"], ["Adult", "Senior"], [], "More enjoyable", "both", "both"],
        ["Tech-themed Bookends", "Bookends with a design inspired by tech gadgets", ["Reading", "Tech and Gadgets"], ["Young Adult", "Adult"], [], "More practical", "both", "both"],
        ["Book Title Generator", "A small electronic gadget that generates random book titles or plot ideas", ["Reading", "Tech and Gadgets"], ["Teen", "Young Adult"], [], "More enjoyable", "both", "both"],
        ["Book Cover Tablet Sleeve", "A tablet sleeve that resembles a book cover", ["Reading", "Tech and Gadgets"], ["Teen", "Adult"], [], "More practical", "both", "both"],
        ["Literary Quote Keychain with LED Light", "A keychain featuring a literary quote and an LED light", ["Reading", "Tech and Gadgets"], ["Adult", "Senior"], [], "More enjoyable", "both", "both"]
        
        ["Book-themed Jigsaw Puzzle", "A jigsaw puzzle showcasing iconic book covers or literary scenes", ["Reading", "Puzzle Solving"], ["Child", "Teen"], [], "More enjoyable", "both", "both"],
        ["Literary Crossword Book", "A book filled with crossword puzzles themed around classic literature", ["Reading", "Puzzle Solving"], ["Teen", "Adult"], [], "More practical", "both", "both"],
        ["Bookmark Puzzle", "A bookmark that also serves as a mini puzzle to solve", ["Reading", "Puzzle Solving"], ["Teen", "Young Adult"], [], "More practical", "both", "both"],
        ["Story Cubes", "Dice with images that help create a narrative or story", ["Reading", "Puzzle Solving"], ["Child", "Teen"], [], "More enjoyable", "both", "both"],
        ["Literary Sudoku Book", "A Sudoku puzzle book that has challenges based on literary characters or books", ["Reading", "Puzzle Solving"], ["Adult", "Senior"], [], "More practical", "both", "both"],
        ["3D Book Puzzle", "A 3D puzzle that forms a model of a famous book or literature scene", ["Reading", "Puzzle Solving"], ["Teen", "Adult"], [], "More enjoyable", "both", "both"],
        ["Bookshelf Logic Puzzle", "A logic puzzle game where players need to organize a bookshelf based on various hints", ["Reading", "Puzzle Solving"], ["Young Adult", "Adult"], [], "More practical", "both", "both"],
        ["Literary Quote Cipher", "A set of encrypted quotes from literature, challenging recipients to decode", ["Reading", "Puzzle Solving"], ["Teen", "Adult"], [], "More enjoyable", "both", "both"],
        ["Magnetic Poetry Puzzle Kit", "A set of magnetic words to form poetic phrases, also functioning as a puzzle", ["Reading", "Puzzle Solving"], ["Teen", "Adult"], [], "More practical", "both", "both"],
        ["Classic Book Cover Brain Teasers", "Brain teasers or riddles presented within classic book cover designs", ["Reading", "Puzzle Solving"], ["Adult", "Senior"], [], "More enjoyable", "both", "both"]
        
        ["Bookish Photo Frames", "Photo frames that resemble book covers or have literary designs", ["Reading", "Photography"], ["Teen", "Adult"], [], "More practical", "both", "both"],
        ["Photo Album that Looks Like a Book", "A photo album that externally resembles a classic book", ["Reading", "Photography"], ["Adult", "Senior"], ["Birthday", "Christmas", "Anniversary"], "More enjoyable", "both", "both"],
        ["Photography-themed Bookmarks", "Bookmarks featuring famous photographs or photography themes", ["Reading", "Photography"], ["Teen", "Young Adult"], [], "More practical", "both", "both"],
        ["Literary Quotes on Photography", "Prints or cards featuring literary quotes related to photography", ["Reading", "Photography"], ["Young Adult", "Adult"], [], "More enjoyable", "both", "both"],
        ["Camera Lens Cleaning Cloth with Book Quotes", "Lens cleaning cloths featuring quotes from literature", ["Reading", "Photography"], ["Teen", "Adult"], [], "More practical", "both", "both"],
        ["DIY Book Cover Photoshoot Kit", "A kit with props and backdrops for creating book cover-themed photos", ["Reading", "Photography"], ["Teen", "Young Adult"], [], "More enjoyable", "both", "both"],
        ["Photography Books for Kids", "Children’s books that explore the basics of photography", ["Reading", "Photography"], ["Child", "Teen"], [], "More practical", "both", "both"],
        ["Bookish Camera Strap", "A camera strap with literary quotes or bookish designs", ["Reading", "Photography"], ["Teen", "Adult"], [], "More enjoyable", "both", "both"],
        ["Photographer's Reading Light", "A portable and adjustable reading light that photographers can use during shoots", ["Reading", "Photography"], ["Young Adult", "Adult"], [], "More practical", "both", "both"],
        ["Storytelling Photo Prompts", "Cards or a book that offers photo prompts aimed at storytelling", ["Reading", "Photography"], ["Teen", "Adult"], [], "More enjoyable", "both", "both"]

        ["Bookish Pop Socket", "A pop socket for phones/tablets featuring famous book covers or literary quotes", ["Reading", "Media Consumption (e.g., Movies, TV Shows, Music, Podcasts)"], ["Teen", "Young Adult"], [], "More practical", "both", "both"],
        ["Literary Movie Poster", "Posters of movies that were adapted from books, with a creative or vintage twist", ["Reading", "Media Consumption (e.g., Movies, TV Shows, Music, Podcasts)"], ["Teen", "Adult"], [], "More enjoyable", "both", "both"],
        ["Book-themed Phone Stand", "A phone stand with designs or quotes from iconic books", ["Reading", "Media Consumption (e.g., Movies, TV Shows, Music, Podcasts)"], ["Child", "Teen"], [], "More practical", "both", "both"],
        ["Bookmark with Built-in Timer", "A bookmark that helps track reading or screen time with a built-in timer", ["Reading", "Media Consumption (e.g., Movies, TV Shows, Music, Podcasts)"], ["Child", "Teen"], [], "More enjoyable", "both", "both"],
        ["Classic Book Cover Coasters", "Coasters featuring classic book covers, perfect for movie or reading nights", ["Reading", "Media Consumption (e.g., Movies, TV Shows, Music, Podcasts)"], ["Adult", "Senior"], [], "More practical", "both", "both"],
        ["Literary-themed Popcorn Box", "Popcorn boxes featuring quotes or images from classic literature for movie nights", ["Reading", "Media Consumption (e.g., Movies, TV Shows, Music, Podcasts)"], ["Teen", "Adult"], [], "More enjoyable", "both", "both"],
        ["Adjustable Book and Tablet Stand", "A stand that can hold both books and tablets for convenient media consumption", ["Reading", "Media Consumption (e.g., Movies, TV Shows, Music, Podcasts)"], ["Young Adult", "Adult"], [], "More practical", "both", "both"],
        ["Book and Movie Comparison Chart", "A chart that allows one to compare and analyze books and their movie adaptations", ["Reading", "Media Consumption (e.g., Movies, TV Shows, Music, Podcasts)"], ["Teen", "Adult"], [], "More enjoyable", "both", "both"],
        ["Literature-based Music Playlists", "Curated music playlists based on famous books or literary themes (access via QR code)", ["Reading", "Media Consumption (e.g., Movies, TV Shows, Music, Podcasts)"], ["Young Adult", "Adult"], [], "More practical", "both", "both"],
        ["Book-inspired Movie Night Kit", "A kit including themed accessories and snacks for watching movies based on books", ["Reading", "Media Consumption (e.g., Movies, TV Shows, Music, Podcasts)"], ["Teen", "Adult"], [], "More enjoyable", "both", "both"]

        ["Literary Recipe Cards", "Recipe cards inspired by meals in popular books and novels", ["Reading", "Cooking or Baking"], ["Teen", "Adult"], [], "More practical", "both", "both"],
        ["Book-themed Cookie Cutters", "Cookie cutters shaped like bookish symbols or characters", ["Reading", "Cooking or Baking"], ["Child", "Teen"], [], "More enjoyable", "both", "both"],
        ["Bookish Kitchen Towels", "Kitchen towels printed with quotes or images from beloved books", ["Reading", "Cooking or Baking"], ["Adult", "Senior"], [], "More practical", "both", "both"],
        ["Literature-inspired Spices and Herbs", "Packages of spices or herbs with labels inspired by literary elements", ["Reading", "Cooking or Baking"], ["Teen", "Adult"], [], "More enjoyable", "both", "both"],
        ["Cookbook Bookmark", "A durable, easy-to-clean bookmark specially designed for cookbooks", ["Reading", "Cooking or Baking"], ["Young Adult", "Adult"], [], "More practical", "both", "both"],
        ["Bookish Oven Mitts", "Oven mitts featuring designs or quotes inspired by popular books", ["Reading", "Cooking or Baking"], ["Adult", "Senior"], [], "More enjoyable", "both", "both"],
        ["Literary Teas", "Tea blends inspired by different genres or famous authors and characters", ["Reading", "Cooking or Baking"], ["Teen", "Adult"], [], "More practical", "both", "both"],
        ["Storytelling Kitchen Utensils", "Kitchen utensils that feature quotes or images from classic literature", ["Reading", "Cooking or Baking"], ["Young Adult", "Adult"], [], "More enjoyable", "both", "both"],
        ["Edible Bookish Decorations", "Edible cake or cupcake decorations that are inspired by literary themes", ["Reading", "Cooking or Baking"], ["Child", "Teen"], [], "More practical", "both", "both"],
        ["Novel Nibbles", "Small snacks or candies packaged with literary themes or puns", ["Reading", "Cooking or Baking"], ["Teen", "Young Adult"], [], "More enjoyable", "both", "both"]
        ...
        ["Bookmark","Creative bookmarks with unique designs.",["Reading"],["Child","Teen"],[],"More practical","both","both"],
        ["Book Light","Clip-on, adjustable book light for reading in dim areas.",["Reading"],["Teen","Young Adult","Adult","Senior"],["Birthday","Christmas","Other/No Specific Occasion"],"More practical","both","both"],
        ["Magnetic Page Markers","Decorative page markers to hold the page in books.",["Reading"],["Child","Teen"],[],"More enjoyable","both","both"],
        ["Book Sleeves","Protective sleeves for keeping books safe while traveling.",["Reading"],["Teen","Young Adult","Adult"],["Birthday","Christmas","Other/No Specific Occasion"],"More practical","both","both"],
        ["Story Cubes","Dice with pictures for creating own stories.",["Reading"],["Child"],[],"More enjoyable","both","both"],
        ["Funky Pencils","Themed pencils to make note-taking more interesting.",["Reading"],["Child","Teen"],[],"More enjoyable","both","both"],
        ["Reading Journal","A journal specifically designed for book lovers.",["Reading"],["Teen","Young Adult","Adult"],["Birthday","Christmas","New Year"],"More practical","both","both"],
        ["Decorative Sticky Notes","Themed sticky notes for annotating while reading.",["Reading"],["Teen","Young Adult"],[],"More enjoyable","both","both"],
        ["Book Holder","A tool that holds a book open, making reading easier.",["Reading"],["Adult","Senior"],["Birthday","Christmas","Other/No Specific Occasion"],"More practical","both","both"],
        ["Themed Coasters","Book-themed coasters for a reading nook.",["Reading"],["Adult","Senior"],[],"More enjoyable","both","both"]
