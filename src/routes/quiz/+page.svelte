<script>
    ...
    let TempQuiz = [
        ...
        ["Should the gift be more practical or enjoyable?", true],
        [
            ["More Practical", false],
            ["More Enjoyable", false],
            ["No Preference", false],
        ],

        //Longer questions
        [
            "Do they have some of the following hobbies?<br/>(Pick all that apply)(1/2)",
            false,
        ],
        [
        ...
        [
            "Do they have some of the following hobbies?<br/>(Pick all that apply)(2/2)",
            false,
        ],
        [
            ...
            ["Photography", false],
            [
                "Media Consumption (e.g., Movies, TV Shows, Music, Podcasts)",
                false,
            ],
...
<main>
    {#key CurrentQuestion}
        <div id="question" key={triggerAnimation}>
            {@html TempQuiz[CurrentQuestion][0]}
        </div>
            ...
            {#each TempQuiz[CurrentQuestion + 1] as Answer, index}
                <button
                    ...
                    on:click={() => {
                        if (Answer[1] === false) {
                            if (
                                TempQuiz[CurrentQuestion][1] === true &&
                                IndexLastAnswer > -1
                            ) {
                                TempQuiz[CurrentQuestion + 1][
                                    IndexLastAnswer
                                ][1] = false;
